...
import { BellIcon, MoonIcon } from "src/components/icons";
          ...
          <div className="px-2 sm:px-4 lg:divide-y lg:divide-gray-200">
            <div className="relative h-16 flex justify-between lg:px-32">
              ...
              <div className="hidden lg:relative lg:z-10 lg:ml-4 lg:flex lg:items-center">
                <button
                  type="button"
                  className="mr-3 flex-shrink-0 bg-white rounded-full p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                >
