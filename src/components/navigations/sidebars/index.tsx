...
const Sidebar: React.FC<SidebarProps> = () => {
  return (
    <div className="bg-white rounded flex flex-col items-center py-6 px-4">
      <Link
        href="#"
        className="w-full bg-gray-900 hover:bg-gray-800 text-white py-2 rounded text-center transition-colors leading-5 mb-6">
        ADD_TICKET
      </Link>
      <Link href="#" className="flex items-center w-full py-3 relative">
        ...
        UserRequest
        <span className="py-0.5 px-1.5 bg-yellow-400 text-white leading-4 rounded text-xs absolute right-0">
          2
        </span>
      </Link>
    </div>
